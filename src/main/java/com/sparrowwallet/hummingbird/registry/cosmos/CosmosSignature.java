...
public class CosmosSignature extends RegistryItem {
    ...
    public CosmosSignature(byte[] signature) {
        this.requestId = null;
        this.signature = signature;
        this.publicKey = null;
    }

    public CosmosSignature(byte[] signature, byte[] requestId) {
        this.requestId = requestId;
        this.signature = signature;
        this.publicKey = null;
    }

    public CosmosSignature(byte[] signature, byte[] requestId, byte[] publicKey) {
        this.requestId = requestId;
        this.signature = signature;
    ...
    public RegistryType getRegistryType() {
        return RegistryType.COSMOS_SIGNATURE;
    }
    ...
    public static CosmosSignature fromCbor(DataItem item) {
        byte[] requestId = null;
        byte[] signature = null;
